          ...
          <q-card-section class="row items-center q-col-gutter-sm justify-end">
            <div class="col-auto row q-gutter-sm">
              ...
              <q-btn
                color="secondary"
                icon="save"
                label="Guardar en JSON"
                no-caps
                @click="saveClothesJson"
              />
              <q-btn
                color="secondary"
                icon="check"
                label="Resetear novedad "
                @click="allProductArentNew"
              />
              <q-btn
                color="grey-8"
                icon="help_outline"
            ...
            <div class="col-12 col-sm-4">
              <q-input
                ...
                outlined
                v-model="filter"
                placeholder="Filtrar por nombre, id o categoría"
                clearable
              >
                <template #prepend>
                  <q-icon name="search" />
        ...
        <q-card-section>
          <div class="row q-col-gutter-md">
            ...
            <div class="col-8">
              ...
              <div v-if="viewItem?.descripcion">
                <strong>Descripción:</strong> {{ viewItem?.descripcion }}
              </div>
            </div>
          </div>
        </q-card-section>
...
const editItem = ref<ClothesItem>({
  id: '',
  name: '',
  price: 0,
  category: '',
...
function allProductArentNew() {
  items.value = items.value.map((product: ClothesItem) => ({
    ...product,
