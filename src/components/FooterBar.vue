<template>
  <q-footer class="bg-grey-1 text-grey-9" bordered>
    <q-toolbar class="q-py-sm q-px-md">
      <div class="row items-center justify-between full-width q-col-gutter-md">
        <!-- Brand / Logo -->
        <div class="row items-center q-gutter-sm">
          <q-img src="/images/logo.png" alt="Mercado Texas" width="28px" height="28px" ratio="1" />
          <div class="text-subtitle2 text-weight-medium">{{ brand }}</div>
        </div>
